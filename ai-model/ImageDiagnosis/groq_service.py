...
#         # Construct Groq-compatible message
#         messages = [{
#             "role": "user",
#             "content": [
...
#         responses = {}
#         for name, model in [("scout", scout_model), ("maverick", maverick_model)]:
#             res = make_api_request(model)
#             if res.status_code == 200:
#                 content = res.json()["choices"][0]["message"]["content"]
#                 responses[name] = content
#             else:
#                 responses[name] = f"Error {res.status_code}: {res.text}"
